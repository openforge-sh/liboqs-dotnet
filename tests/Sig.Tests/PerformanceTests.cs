...
#pragma warning restore S1215
    ...
    public void LongRunning_PerformanceStability()
    {
        ...
        {
            TimingUtils.EnvironmentType.CI => 250.0,     // Very lenient for CI (high variance expected due to shared resources)
        ...
        {
            TimingUtils.EnvironmentType.CI => 2.5,       // Allow 150% degradation in CI
