...
public sealed class EndToEndTests(LibOqsTestFixture fixture)
{
    ...
    private static readonly string[] action = ["Alice", "Bob", "Charlie", "Dave"];
    private static readonly string[] actionArray = ["Bob", "Charlie"];
    ...
    public void SecureMessaging_EndToEndScenario_ShouldWorkCorrectly()
    {
        ...
        TestExecutionHelpers.ConditionallyExecuteWithLargeStack(aliceSignAlgorithm, () =>
        {
            TestExecutionHelpers.ConditionallyExecuteWithLargeStack(kemAlgorithm, () =>
            {
    ...
    public void HybridCryptography_MultipleRecipients_ShouldWork()
    {
        ...
        TestExecutionHelpers.ConditionallyExecuteWithLargeStack(signAlgorithm, () =>
        {
            TestExecutionHelpers.ConditionallyExecuteWithLargeStack(kemAlgorithm, () =>
            {
        ...
        TestExecutionHelpers.ExecuteWithLargeStack(() =>
        {
            ...
            foreach (var kemAlg in kemAlgorithms)
            {
                foreach (var sigAlg in signAlgorithms)
                {
                    try
                    {
                        TestExecutionHelpers.ConditionallyExecuteWithLargeStack(kemAlg, () =>
                        {
                            TestExecutionHelpers.ConditionallyExecuteWithLargeStack(sigAlg, () =>
                            {
    ...
    public void RealWorldScenario_SecureEmailSystem_ShouldWork()
    {
        ...
        TestExecutionHelpers.ConditionallyExecuteWithLargeStack(signAlgorithm, () =>
        {
            TestExecutionHelpers.ConditionallyExecuteWithLargeStack(kemAlgorithm, () =>
            {
                ...
                foreach (var username in action)
                {
                ...
                try
                {
                    ...
                    foreach (var recipient in actionArray)
                    {
